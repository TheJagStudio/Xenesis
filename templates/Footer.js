...
const Footer = () => {
  return (
    <>
        <div className='flex justify-around px-32 my-2 mb-8'>
            <div className='flex flex-col items-center gap-3'>
                ...
                <div className='flex items-center justify-center gap-5 mt-3'>
                    <a href='' className='text-[#9740fe] text-2xl hover:-translate-y-2 hover:text-[#dfc5ff] transition-all duration-300'><i className="bi bi-facebook"></i></a>
                    <a href='' className='text-[#9740fe] text-2xl hover:-translate-y-2 hover:text-[#dfc5ff] transition-all duration-300'><i className="bi bi-twitter"></i></a>
                    <a href='' className='text-[#9740fe] text-2xl hover:-translate-y-2 hover:text-[#dfc5ff] transition-all duration-300'><i className="bi bi-instagram"></i></a>
                    <a href='' className='text-[#9740fe] text-3xl hover:-translate-y-2 hover:text-[#dfc5ff] transition-all duration-300'><i className="bi bi-youtube"></i></a>
                </div>
            </div>
            <div className='pt-4'>
            ...
            <div className='pt-4'>
                ...
                <div className='flex flex-col text-left gap-2 text-gray-400 pl-2'>
                    ...
                    <div className='flex flex-col group cursor-pointer'>
                        ...
                        <p className='text-gray-300 text-sm group-hover:translate-x-2 transition-all duration-300'>+91 999 999 9999</p>
                    </div>
                </div>
            </div>
            <div className='pt-4'>
        ...
        <div className='bg-[#0c0c35] w-fit px-24 pr-36 mb-0 clip-copyrights text-gray-300 font-semibold py-8 text-xl'>
