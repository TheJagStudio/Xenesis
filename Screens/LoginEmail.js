	...
	return (
		<SafeAreaView className="bg-white dark:bg-[#28272C] h-full" style={{ paddingTop: Platform.OS === "android" ? 40 : 0 }}>
			...
			<KeyboardAvoidingView behavior="position">
				...
				<StyledTouchableOpacity onPress={() => navigation.navigate("PasswordRecovery")} className="w-full items-center mt-3">
					<StyledText className="w-fit text-gray-500 text-md">Forgot Password</StyledText>
				</StyledTouchableOpacity>
				<StyledView className="w-[80%] mx-[10%] mt-10">
					<StyledTouchableOpacity className="rounded-full w-[80%] mx-[10%] bg-[#FEA500] shadow-xl mb-3" onPress={() => navigation.navigate("AccountSetup")}>
